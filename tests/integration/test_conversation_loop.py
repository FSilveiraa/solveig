...
class TestRealWorldConversationScenarios:
    ...
    def test_slow_computer_diagnosis_scenario(
        ...
        mock_get_prompt.return_value = (
            "You are a helpful assistant that can run commands and read files."
        )
        ...
        llm_response = LLMMessage(
            ...
            requirements=[
                ...
                CommandRequirement(command="df -h", comment="Check disk space usage"),
                CommandRequirement(
        ...
        try:
            main_loop(
                DEFAULT_CONFIG,
                interface,
                "My computer is running very slow, can you help me figure out why?",
            )
        except ValueError:
            pass
    ...
    def test_file_organization_scenario(
        ...
        # Setup
        mock_get_prompt.return_value = (
            "You are a helpful assistant that can organize files and directories."
        )
        ...
        try:
            main_loop(
                DEFAULT_CONFIG,
                interface,
                "Can you help me organize all the files in my Downloads folder? It's a complete mess.",
            )
        except ValueError:
            pass
    ...
    def test_suspicious_script_analysis_scenario(
        ...
        # Setup
        mock_get_prompt.return_value = (
            "You are a security-focused assistant that can analyze files safely."
        )
        ...
        try:
            main_loop(
                DEFAULT_CONFIG,
                interface,
                "I found this script called 'suspicious_script.sh' on my computer. Can you tell me what it does? I'm worried it might be malware.",
            )
        except ValueError:
            pass
