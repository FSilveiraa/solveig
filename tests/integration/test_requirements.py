...
class TestCommandRequirement:
    ...
    def test_auto_execute_matching_pattern(self, mock_subprocess):
    ...
    def test_auto_execute_with_flags(self, mock_subprocess):
    ...
    def test_auto_execute_empty_patterns(self, mock_subprocess):
