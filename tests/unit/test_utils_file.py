...
class TestFileValidation:
    ...
    def test_validate_write_access_insufficient_disk_space(
...
class TestFileOperations:
    ...
    def test_write_file_or_directory_file(self, mock_all_file_operations):
        ...
        file_utils.write_file_or_directory(
            "/test/file.txt", is_directory=False, content="test content"
        )
    ...
    def test_copy_file_or_directory_file(self, mock_all_file_operations):
        ...
        assert mock_all_file_operations.exists(
            "/source/file.txt"
        )  # Original still exists
        assert mock_all_file_operations.exists("/dest/file.txt")  # Copy created
        assert (
            mock_all_file_operations.get_content("/dest/file.txt") == "source content"
        )
