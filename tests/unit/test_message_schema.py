...
class TestSchemaConsistency:
    ...
    def test_different_configs_produce_different_schemas(self):
        ...
        with patch('solveig.schema.REQUIREMENTS.registered', mock_requirements):
            class_with_commands = get_filtered_assistant_message_class(config_with_commands)
            class_without_commands = get_filtered_assistant_message_class(config_without_commands)
