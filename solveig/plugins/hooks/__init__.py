...
def _announce_register(verb, fun: Callable, requirements):
    req_types = ", ".join([req.__name__ for req in requirements]) if requirements else "any requirements"
...
def load_hooks():
    ...
    print(f"🎯 Plugin loading complete: {loaded_count} files, {total_hooks} hooks registered")
