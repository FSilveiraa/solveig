...
from solveig.schema.result.copy import CopyResult
...
async def copy(
    ...
    async with interface.with_group(
        ...
        if auto_copy:
            ...
            return ToolReturn(return_value="User declined the copy.")
        ...
        try:
            ...
            return ToolReturn(
                return_value=f"Copied {abs_source_path} to {abs_destination_path}",
                metadata=CopyResult(
                    accepted=True,
